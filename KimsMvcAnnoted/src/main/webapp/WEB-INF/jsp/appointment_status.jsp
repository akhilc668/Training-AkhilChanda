...
<body bgcolor="wheat">
	...
	<center>
		...
		<br>
		<br> <a href="/KimsMvcAnnoted/patient_home">Home</a> | <a
			href="/KimsMvcAnnoted/patient_profile">Profile</a> | <a
			href="/KimsMvcAnnoted/appointment">Appointment</a> | <a
			href="/KimsMvcAnnoted/appointment_status">Appointment status</a> | <a
			href="/KimsMvcAnnoted/index">Logout</a>
	</center>
	<br>
	<br>
