...
<body bgcolor="wheat">
	...
	<center>
		...
		<br> <br> <a href="/KimsMvcAnnoted/patient_home">Home</a> | <a
			href="/KimsMvcAnnoted/patient_profile">Profile</a> | <a href="/KimsMvcAnnoted/index">Logout</a>
	</center>
	<br>
	<br>
<form:form action="/KimsMvcAnnoted/update_patient" method="post" modelAttribute="patient" align="center">
