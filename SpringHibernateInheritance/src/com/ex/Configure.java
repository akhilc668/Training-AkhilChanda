...
public class Configure {
	...
	public LocalSessionFactoryBean getSession() {
		...
		lsfb.setAnnotatedClasses(Payment.class,Cheque.class,CreditCard.class);
	...
	@Bean
	public JoinSubclass hTemplatej() {
		JoinSubclass ss = new JoinSubclass();
		ss.setHbTemplate(ht);
		return ss;
	}
	
	@Bean
	public UnionSubClass hTemplateu() {
		UnionSubClass ss = new UnionSubClass();
		ss.setHbTemplate(ht);
		return ss;
	}
}
