...
<br><br>
<form:form action="/KimsApplicationSpring/add_doctor" method="post" modelAttribute="dregister" align="center">
...
<form:radiobutton path="gender" value="female" />Female<br><br><br><br>
